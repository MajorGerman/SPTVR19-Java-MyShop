...
class App {
    ...
    Person pers = new Person(money);  // Создаем человека с установленным ранее количеством денег
    ...
    public void run() throws Exception {
        ...
        checkSave(); // Проверяем сохраненные предметы и, при их наличии, добавляем их в инвентарь
                                    ...
                                    if (pers.getSpecialThings(i) != null && this_thing != null) { 
                                        ...
                                        if (ID1 == ID2) {                           // Сравниваем ID
                                                ...
                                                StringToWrite = (String)(this_thing.getName() + " "
                                                                      + this_thing.getCount() + " "
                                                                      + this_thing.getPrice() + " "
                                                                      + (-1*this_thing.getID()-pers.getItemsCount()*rand.nextInt(10)) + "\n");
